...
class XpcSpiderMiddleware(object):
    ...
    def __init__(self, settings):
        ...
        self.prox_redis_key = settings.get("PROXY_REDIS_KEY")
    ...
    def spider_opened(self, spider):
        ...
        r = redis.StrictRedis(host="www.fand.wang", password="fanding", port=6379, db=10)
        r.lpush(self.prox_redis_key, *(self.proxies))
